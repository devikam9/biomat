    ...
    if ($date < $today) {
        ...
        if ($hours < 9 || $hours > 16 || ($hours == 16 && $minutes > 0)) {
            ...
            if ($result_check->num_rows > 0) {
                ...
                echo "above the insert";
                // Insert new appointment
                $query = "INSERT INTO appointment (date, time, donation_center, uuid, donation_id) 
                          VALUES ( '$date', '$time', '$donation_center_id', '$donor_ssn', '$donation_id')";
...
<body>
    ...
    <h3>
    <a href="viewappointment.php?uuid=<?php echo urlencode($uuid); ?>"> view appointment </a> |
    <a href="updateappointment.php?uuid=<?php echo urlencode($uuid); ?>"> update appointment </a>|
    <a href="cancelappointment.php?uuid=<?php echo urlencode($uuid); ?>"> cancel appointment </a>
    </h3>
</body>
</html>
