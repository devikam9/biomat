        ...
        if ($hours < 9 || $hours > 16 || ($hours == 16 && $minutes > 0)) {
            ...
            if ($result_check->num_rows > 0) {
                ...
                $query = "INSERT INTO appointment (date, time, donation_center, uuid, donation_id) 
                          VALUES ('$date', '$time', '$donation_center', '$donor_ssn', '$donation_id')";
...
<body>
    <header>
        <div class="header-buttons">
            ...
            <button class="nav-button" onclick="location.href='./cancelappointment.php?uuid=<?php echo urlencode($uuid); ?>'">Cancel Appointment</button>
    ...
    <main>
        <div class="form-container">
            ...
            <?php endforeach; ?>
                ...
                Donor SSN: <input type='text' name='donor_ssn' required><br>
